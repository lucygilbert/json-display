describe('Style overrides', function() {
  ...
  function checkStyleResults(htmlTree, expectedOptions) {
    ...
    expect(htmlTree.firstChild.style.cssText).to.equal(expectedOptions.title.style);
    expect(htmlTree.firstChild.firstChild.style.cssText).to.contain(
      expectedOptions.openButton.style);
    expect(htmlTree.firstChild.childNodes[1].style.cssText).to.equal(
      expectedOptions.titleText.style);
    expect(htmlTree.childNodes[1].style.cssText).to.contain(
      expectedOptions.contentsContainer.style);
    expect(htmlTree.childNodes[1].childNodes[2].style.cssText).to.equal(
      expectedOptions.keyValuePair.style);
    expect(htmlTree.childNodes[1].childNodes[2].firstChild.style.cssText).to.equal(
      expectedOptions.key.style);
    expect(htmlTree.childNodes[1].childNodes[3].childNodes[1].style.cssText).to.equal(
      expectedOptions.stringValue.style);
    expect(htmlTree.childNodes[1].childNodes[2].childNodes[1].style.cssText).to.equal(
      expectedOptions.numberValue.style);
    expect(htmlTree.childNodes[1].childNodes[4].childNodes[1].style.cssText).to.equal(
      expectedOptions.booleanValue.style);
    expect(htmlTree.childNodes[1].childNodes[5].childNodes[1].style.cssText).to.equal(
      expectedOptions.nullValue.style);
  }


  function checkTagResults(htmlTree, expectedOptions) {
    expect(htmlTree.tagName).to.equal(expectedOptions.root.tag.toUpperCase());
    expect(htmlTree.firstChild.tagName).to.equal(expectedOptions.title.tag.toUpperCase());
    expect(htmlTree.firstChild.firstChild.tagName).to.contain(
      expectedOptions.openButton.tag.toUpperCase());
    expect(htmlTree.firstChild.childNodes[1].tagName).to.equal(
      expectedOptions.titleText.tag.toUpperCase());
    expect(htmlTree.childNodes[1].tagName).to.contain(
      expectedOptions.contentsContainer.tag.toUpperCase());
    expect(htmlTree.childNodes[1].childNodes[2].tagName).to.equal(
      expectedOptions.keyValuePair.tag.toUpperCase());
    expect(htmlTree.childNodes[1].childNodes[2].firstChild.tagName).to.equal(
      expectedOptions.key.tag.toUpperCase());
    expect(htmlTree.childNodes[1].childNodes[3].childNodes[1].tagName).to.equal(
      expectedOptions.stringValue.tag.toUpperCase());
    expect(htmlTree.childNodes[1].childNodes[2].childNodes[1].tagName).to.equal(
      expectedOptions.numberValue.tag.toUpperCase());
    expect(htmlTree.childNodes[1].childNodes[4].childNodes[1].tagName).to.equal(
      expectedOptions.booleanValue.tag.toUpperCase());
    expect(htmlTree.childNodes[1].childNodes[5].childNodes[1].tagName).to.equal(
      expectedOptions.nullValue.tag.toUpperCase());
  }
